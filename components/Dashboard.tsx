                    ...
                    <div className="container mx-auto px-4 py-8">
                        <header className="mb-10 text-center">
                            <h1 className="text-4xl font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-brand-400 to-accent-500">
                                {analysisResult ? "Analysis Report" : "AI Gameplay Analysis"}
                            </h1>
                            {!analysisResult && (
                        ...
                        {!analysisResult && !videoFile ? (
                            ...
                            // Analysis View or Preview State
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                                ...
                                <div className="lg:col-span-3 space-y-6">
                                    <div className="glass-card rounded-2xl overflow-hidden border border-white/10 relative group">
                                        ...
                                        {!analysisResult && ( // Show clear button only if not analyzing/viewing history? 
                                            // Actually, forcing user to stay on analysis unless they click "New Analysis" is better
                                            // But for preview (before analysis), we need clear.
                                            <button
                                                onClick={clearFile}
                                ...
                                <div className="lg:col-span-2">
                                    {analysisResult ? (
                                        <div className="sticky top-24">
                                            <ChatWidget analysisId={analysisResult.id} />
                                        </div>
                                    ) : (
