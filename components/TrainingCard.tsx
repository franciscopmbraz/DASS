        ...
        <div className="group relative bg-slate-900/40 backdrop-blur-sm rounded-2xl p-6 border border-white/5 hover:border-brand-500/30 transition-all duration-300 hover:shadow-[0_0_30px_rgba(20,184,166,0.1)] overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <div className="flex gap-3">
                    <button className="flex-1 bg-brand-600 hover:bg-brand-500 text-white py-3 rounded-xl font-bold transition-all shadow-lg shadow-brand-900/20 group-hover:shadow-brand-500/20 flex items-center justify-center">
                        {training.status === 'new' ? (
                    ...
                    <button className="p-3 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white rounded-xl transition-colors border border-white/5">
